     ...
     <div className="flex lg:flex-row md:flex-row flex-col px-[5%] pb-[5%] gap-8">
        <div className="basis-3/5">
          <div className="-my-6">
            ...
            <div className="relative pl-8 sm:pl-3 pt-6 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-blue-400 after:rounded-full  after:-translate-x-1/2 after:translate-y-1.5"></div>
              <div className="pop-font lg:text-lg md:text-lg text-primary font-bold">{props.timelineh6}
            ...
            <div className="relative pl-8 sm:pl-3 pt-6 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-blue-400 after:rounded-full  after:-translate-x-1/2 after:translate-y-1.5"></div>
              <div className="pop-font lg:text-lg md:text-lg text-primary font-bold">{props.timelineh7}
            ...
            <div className="relative pl-8 sm:pl-3 pt-6 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-blue-400 after:rounded-full  after:-translate-x-1/2 after:translate-y-1.5"></div>
              <div className="pop-font lg:text-lg md:text-lg text-primary font-bold">{props.timelineh8}
            ...
            <div className="relative pl-8 sm:pl-3 pt-6 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-blue-400 after:rounded-full  after:-translate-x-1/2 after:translate-y-1.5"></div>
              <div className="pop-font lg:text-lg md:text-lg text-primary font-bold">{props.timelineh9}
            ...
            <div className="relative pl-8 sm:pl-3 pt-6 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-blue-400 after:rounded-full  after:-translate-x-1/2 after:translate-y-1.5"></div>
              <div className="pop-font lg:text-lg md:text-lg text-primary font-bold">{props.timelineh10}
