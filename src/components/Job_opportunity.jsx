...
function Job_opportuninty() {
  return (
    <>
    <div className="flex lg:flex-row  flex-col pl-[5%] pr-[5%] pt-[5%] gap-8 dark:bg-neutral-200">
      ...
      Job Opportunities
          ...
          <p className="lg:text-lg md:text-lg text-sm font-serif font-normal py-2">
          <span className="text-primary font-bold dark:text-black">Flexible Working Hours and Schedules:</span>{" "}
    ...
    <div className="flex  flex-col pl-[5%] pr-[5%] pb-[5%] dark:bg-neutral-200">
