...
function Contact_us() {
  return (
    <>
      <div className="contact-us justify-center text-center pt-11 dark:bg-neutral-200">
      <h2 className='font-serif font-bold lg:text-4xl  md:text-4xl text-2xl text-primary  dark:text-black'>Contact us</h2>
...
<div className="left">
  ...
  <h2 className='font-serif font-bold lg:text-base  md:text-base text-sm text-primary py-2 dark:text-black'>info@massiecpa.com</h2>
</div>
<div className="right">
<h2 className='text-lg font-serif text-black font-bold py-2'>Phone</h2>
<h2 className='font-serif font-bold lg:text-base  md:text-base text-sm text-primary py-2 dark:text-black'>+1 (360) 687-1562</h2>
