  ...
  return (
    <>
      <div className='text-center mt-12 pr-[5%]  pl-[5%]'>
        ...
        <button className='text-white bg-primary rounded p-3 hover:bg-white hover:border-2 hover:border-primary hover:text-primary font-bold mt-7 w-32'><Link to="/discover-your-dream">Learn More</Link></button>
      </div>
    </>
  )
}
